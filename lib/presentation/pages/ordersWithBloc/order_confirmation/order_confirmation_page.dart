...
import 'package:rrt_ecommerce_app/presentation/pages/ordersWithBloc/order_confirmation/address_bar.dart';
...
class _OrderConfirmationPageState extends State<OrderConfirmationPage> {
  ...
  void _showOrderSuccessDialog(BuildContext context, List<CartItem> cartItems) {
    ...
    BlocProvider.of<OrderBloc>(
      context,
    ).add(PlaceOrderEvent(cartItems, address ?? addressesList[0]));
    ...
    return Scaffold(
      ...
      body: BlocBuilder<CartBloc, CartState>(
        builder: (context, state) {
          ...
          final selectAddressbloc = context.watch<SelectAddressBloc>();
          ...
          return Column(
            children: [
              AddressBar(address: selectAddressbloc.state.userAddress),
              Expanded(
